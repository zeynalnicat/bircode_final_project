...
sealed class ScreenModel(val route:String) {
    ...
    data object PayOperation:ScreenModel(route = "pay-operation/{transactionType}/{isTopUp}/{isBankToBank}"){
        fun withTransactionType(transactionType:String,isTopUp: Boolean,isBankToBank: Boolean) = "pay-operation/$transactionType/$isTopUp/$isBankToBank"
    }
